...
export const Footer = () => {
  return (
    <div className="flex   mt-5 w-full text-white gap-5 flex-col items-center justify-center bg-purple-900">
      <div className="mt-10">
        <img
      ...
      <p className="font-normal text-sm p-2 ">
      ...
      <div className="flex flex-row font-bold gap-5 ">
        <div>
      ...
      <div className="flex flex-row gap-x-5 mt-5">
        <div className="flex justify-center items-center hover:bg-purple-950  bg-purple-700 rounded-full w-[50px] h-[50px]">
